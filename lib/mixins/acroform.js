...
export default {
  ...
  async endAcroForm() {
    if (this._root.data.AcroForm) {
      ...
      for (const fieldRef of this._root.data.AcroForm.data.Fields) {
        await this._endChild(fieldRef);
      }
      await this._root.data.AcroForm.end();
    }
    return this;
  },
  ...
  async _endChild(ref) {
    if (Array.isArray(ref.data.Kids)) {
      for (const childRef of ref.data.Kids) {
        await this._endChild(childRef);
      }
      await ref.end();
    }
    return this;
