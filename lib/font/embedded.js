import { getBuffer } from '../adapters';
...
class EmbeddedFont extends PDFFont {
  ...
  async embed() {
    ...
    await fontFile.end(this.subset.encode());
    ...
    this.dictionary.data = {
      ...
      ToUnicode: await this.toUnicodeCmap(),
    };

    return await this.dictionary.end();
  }
